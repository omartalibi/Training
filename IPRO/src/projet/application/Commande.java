...
import static projet.metier.SellableFraisPortProvider.*;
import static projet.metier.SellableReductionProvider.*;
import static projet.typage.FraisPort.FraisPort;
...
public class Commande {
    ...
    private Reduction calculReductionCommande() throws IOException {
            ...
            return Reduction.Reduction(result);
    }
