...
public class CustomerShould {
    ...
    public void customer_with_one_rental() throws Exception {
        Movie movie = movie(name("le diner de cons"), MovieCategories.regular);
    ...
    public void customer_with_priceCode_children() throws Exception {
        Movie movie = movie(name("le diner de cons"), MovieCategories.children);
    ...
    public void customer_with_priceCode_new_release() throws Exception {
        Movie movie =  movie(name("le diner de cons"), MovieCategories.new_release);
